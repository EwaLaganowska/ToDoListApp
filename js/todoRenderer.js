var todoRenderer = (function(renderer) {
    ...
    renderer.addItem = function (todoModel) {
        let list = (todoModel.isCompleted) ? document.getElementById('completed') : document.getElementById('todo');
        let item = document.createElement('li');
        item.innerText = todoModel.description;
